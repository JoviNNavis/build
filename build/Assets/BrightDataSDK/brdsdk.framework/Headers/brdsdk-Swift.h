...
+ (void)opt_out;
+ (void)clear_choice;
- (nullable instancetype)initWithBenefit:(NSString * _Nullable)benefit agree_btn:(NSString * _Nullable)agree_btn disagree_btn:(NSString * _Nullable)disagree_btn tracking_id:(NSString * _Nullable)tracking_id cwd:(NSURL * _Nullable)_cwd sys_app_id:(NSString * _Nullable)sys_app_id language:(NSString * _Nullable)language skip_consent:(BOOL)skip_consent error:(NSError * _Nullable * _Nullable)error on_choice_change:(void (^ _Nullable)(NSInteger))on_choice_change OBJC_DESIGNATED_INITIALIZER;
...
+ (void)show_consent:(UIViewController * _Nonnull)parent benefit:(NSString * _Nullable)benefit agree_btn:(NSString * _Nullable)agree_btn disagree_btn:(NSString * _Nullable)disagree_btn language:(NSString * _Nullable)language;
@end
